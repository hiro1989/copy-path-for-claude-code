...
- [ ] 2.1 Add stub for config-gated sort wiring in `extension.ts`: extract editor `.map()` result into a variable, add conditional sort call site (no-op, always disabled) for both explorer and editor paths
